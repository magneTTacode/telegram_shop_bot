...
user_keyboard = InlineKeyboardMarkup(inline_keyboard=[
    ...
    [
        InlineKeyboardButton(text="Доставка", url="https://telegra.ph/O-NAS-06-27-6"),
        InlineKeyboardButton(text="О Нас", url="https://telegra.ph/O-nas-06-26-2"),
        InlineKeyboardButton(text="Менеджер", url="https://telegra.ph/Svyaz-s-menedzherom-07-03"),
    ]
])
